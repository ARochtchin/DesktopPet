...
namespace AvaloniaGif
{
    public class GifImage : Control
    {
        ...
        static GifImage()
        {
            SourceUriRawProperty.Changed.Subscribe(new AnonymousObserver<AvaloniaPropertyChangedEventArgs<string>>(SourceChanged));
            SourceUriProperty.Changed.Subscribe(new AnonymousObserver<AvaloniaPropertyChangedEventArgs<System.Uri>>(SourceChanged));
            SourceStreamProperty.Changed.Subscribe(new AnonymousObserver<AvaloniaPropertyChangedEventArgs<System.IO.Stream>>(SourceChanged));
            IterationCountProperty.Changed.Subscribe(new AnonymousObserver<AvaloniaPropertyChangedEventArgs<Avalonia.Animation.IterationCount>>(IterationCountChanged));
            AutoStartProperty.Changed.Subscribe(new AnonymousObserver<AvaloniaPropertyChangedEventArgs<bool>>(AutoStartChanged));
